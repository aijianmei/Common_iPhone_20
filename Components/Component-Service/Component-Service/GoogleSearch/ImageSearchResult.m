...
- (id)initWithDict:(NSDictionary *)dict
{
    self = [super init];
    if (self) {
        self.titleNoFormatting = [dict objectForKey:@"titleNoFormatting"];
        self.unescapedUrl = [dict objectForKey:@"unescapedUrl"];
        self.url = [dict objectForKey:@"url"];
        self.visibleUrl = [dict objectForKey:@"visibleUrl"];
        
        self.width = [[dict objectForKey:@"width"] intValue];
        self.height = [[dict objectForKey:@"height"] intValue];
        self.tbWidth = [[dict objectForKey:@"tbWidth"] intValue];
        self.tbHeight = [[dict objectForKey:@"tbHeight"] intValue];
        
        self.tbUrl = [dict objectForKey:@"tbUrl"];
    }
    return self;
}
