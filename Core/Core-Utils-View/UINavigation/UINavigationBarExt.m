...
{
	return [NSString stringWithFormat:@"%08X-Barbackground", (int)self];
}

- (NSString*)getBackgroundIndexKey
{
	return [NSString stringWithFormat:@"%08X-BarbackgroundIndex", (int)self];
}

- (NSString*)getBackgroundTimerKey
{
	return [NSString stringWithFormat:@"%08X-BarbackgroundTimer", (int)self];
}
