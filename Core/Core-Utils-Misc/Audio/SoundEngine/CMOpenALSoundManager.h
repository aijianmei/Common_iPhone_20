...
{	
	...
	NSMutableArray				*soundFileNames;	// array that holds the filenames for the sounds, they will be referenced by index
...
@property (nonatomic, retain) NSMutableArray *soundFileNames;
