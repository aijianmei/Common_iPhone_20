...
- (void)showWebView
{
    ...
    NSLog(@"WebView Frame=%@ View Frame=%@", NSStringFromCGRect(webView.frame), NSStringFromCGRect(modalBackgroundView.frame));
...
- (void)show
{
    ...
    NSLog(@"WebView Frame=%@ View Frame=%@", NSStringFromCGRect(webView.frame), NSStringFromCGRect(self.frame));
...
- (void)showInView:(UIView *)view
{
    ...
    webView.frame = CGRectMake(0, -20, innerWidth,
                               self.frame.size.height - (1 + kBorderWidth*2));
